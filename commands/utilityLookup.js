...
module.exports = {
    ...
    async execute(interaction) {
        console.log(chalk.blue(`${interaction.user.tag} used the command: /lookup`))
    ...
    **Registration Date:** <t:${Math.floor((new Date(User.createdAt).valueOf()) / 1000)}:R> ${User.createdAt.toLocaleString()} (DD/MM/YYYY) 
